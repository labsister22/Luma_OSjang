...
void handle_cd(const char* path, int current_row) {
    print_string("cd: Not implemented. No suitable kernel syscall for file reading.", current_row , 0);
    (void)path;
    (void)current_row;
}

void handle_ls(int current_row) {
    print_string("ls: Not implemented. No kernel syscall for directory listing.", current_row, 0);
    (void)current_row;
}

void handle_mkdir(const char* name, int current_row) {
    print_string("mkdir: Not implemented. No kernel syscall for creating directories.", current_row, 0);
    (void)name;
    (void)current_row;
}

void handle_cat(const char* filename, int current_row) {
    print_string("cat: Not implemented. No suitable kernel syscall for file reading.", current_row, 0);
    (void)filename;
    (void)current_row;
}

void handle_cp(const char* source, const char* destination, int current_row) {
    print_string("cp: requires two arguments, not supported with current string functions.", current_row, 0);
...
void handle_rm(const char* path, int current_row) {
    print_string("rm: Not implemented. No kernel syscall for removing files/directories.", current_row, 0);
    (void)path;
    (void)current_row;
}

void handle_mv(const char* source, const char* destination, int current_row) {
    print_string("mv: requires two arguments, not supported with current string functions.", current_row, 0);
...
void handle_find(const char* name, int current_row) {
    print_string("find: Not implemented. No kernel syscall for recursive file search.", current_row, 0);
    (void)name;
    (void)current_row;
}